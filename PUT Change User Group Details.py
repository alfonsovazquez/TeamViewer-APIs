...
import json
f = open('output.txt', 'w')
url = 'https://webapi.teamviewer.com/api/v1/users/USERGROUPID/groups/GROUPID'
payload = {'name': 'GROUPNAME', 'Policy_ID':''}
headers = {"content-type": "application/json", "Authorization": "Bearer COMPANYTOKEN HERE"}
